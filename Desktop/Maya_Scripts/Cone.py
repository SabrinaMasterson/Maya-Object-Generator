...
scaleF_r = .1,\
    ...
    for i in range( 0, 50 ):
       ...
       #create cube
    	cmds.polyCone( sx=1, sy=1, sz=1, r=1, h=1, n='cone{}'.format(i))
    	...
    	#apply variabels
    	cmds.rotate( xRot, yRot, zRot, 'cone{}'.format(i))
    	
    	cmds.scale(scaleF, scaleF, scaleF, 'cone{}'.format(i))
    	
    	cmds.move( x, y, z, 'cone{}'.format(i))
    	
    	cmds.sets( name='ConeMaterial{}'.format(i), renderable=True, empty=True )
    	cmds.shadingNode( 'phong', name='ConeShader{}'.format(i), asShader=True )
    	cmds.setAttr( 'ConeShader{}'.format(i)+'.color', r, g, b, type='double3' )
    	cmds.surfaceShaderList( 'ConeShader{}'.format(i), add='ConeMaterial{}'.format(i))
    	cmds.sets( 'cone{}'.format(i), forceElement='ConeMaterial{}'.format(i))
PolyCones()